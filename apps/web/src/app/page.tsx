      ...
      <header className="container mx-auto px-4 py-6">
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link 
              href="/auth/signup" 
              className="px-4 py-2 text-sm font-medium bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors shadow-glow"
            >
              Get Started
            </Link>
          </div>
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/auth/signup" 
              className="px-8 py-4 text-lg font-medium bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-all shadow-glow animate-in"
            >
              Start Creating
            </Link>
            <Link 
              href="/demo" 
              className="px-8 py-4 text-lg font-medium border border-border rounded-lg hover:bg-secondary transition-all animate-in"
            >
              View Demo
            </Link>
          </div>
        ...
        <div className="mt-24 text-center">
          <div className="glass p-8 rounded-lg max-w-2xl mx-auto">
            ...
            <Link 
              href="/auth/signup" 
              className="inline-flex items-center px-8 py-4 text-lg font-medium bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-all shadow-glow"
            >
              Get Started Free
